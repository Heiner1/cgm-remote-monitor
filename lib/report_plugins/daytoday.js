...
daytoday.html = function html (client) {
  ...
  var ret =
    ...
    '<label><input type="checkbox" id="rp_optionsnotes" checked>' + translate('Notes') + '</label>' +
    ...
    '<label><input type="checkbox" id="rp_optionsiob" checked><span style="color:blue;opacity:0.5">' + translate('IOB') + '</span></label>' +
    '<label><input type="checkbox" id="rp_optionscob" checked><span style="color:red;opacity:0.5">' + translate('COB') + '</span></label>' +
    '<label><input type="checkbox" id="rp_optionspredicted"><span style="color:sienna;opacity:0.5">' + translate('Predictions') + '</span></label>' +
    '<label><input type="checkbox" id="rp_optionsopenaps" checked><span style="color:sienna;opacity:0.5">' + translate('OpenAPS') + '</span></label>' +
    ...
    '  <option x="1000" y="300" selected>1000x300px' +
    '  <option x="1200" y="400">1200x400px</option>'</option> +
