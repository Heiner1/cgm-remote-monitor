...
daytoday.html = function html(client) {
  ...
  var ret =
    ...
    + '<input type="checkbox" id="rp_optionsiob" checked><span style="color:blue;opacity:0.5">'+translate('IOB')+'</span>'
    + '<input type="checkbox" id="rp_optionscob" checked><span style="color:red;opacity:0.5">'+translate('COB')+'</span>'
    + '<input type="checkbox" id="rp_optionspredicted"><span style="color:sienna;opacity:0.5">'+translate('Predictions')+'</span>'
    + '<input type="checkbox" id="rp_optionsopenaps" checked><span style="color:sienna;opacity:0.5">'+translate('OpenAPS')+'</span>'
    ...
    + '  <option x="1200" y="400" selected>my-optimum</option>'
